            ...
            switch (req.getParameter("sort")) {
                case "name":
                    setSort(Integer.parseInt(req.getParameter("pagination")),
                            testService.findAllTestNameSort(req.getParameter("subject"),
                                    Integer.parseInt(req.getParameter("pagination")),
                                    req.getParameter("type"),
                                    req.getParameter("offset").equals("") ? 0
                ...
                case "question":
                    setSort(Integer.parseInt(req.getParameter("pagination")),
                            testService.findAllTestByQuestionSort(req.getParameter("subject"),
                                    Integer.parseInt(req.getParameter("pagination")),
                                    req.getParameter("type"),
                                    req.getParameter("offset").equals("") ? 0
                                            : Integer.parseInt(req.getParameter("offset"))),
                ...
                case "hard":
                    setSort(Integer.parseInt(req.getParameter("pagination")),
                            testService.findTestsByComplexitySort(req.getParameter("subject"),
                                    Integer.parseInt(req.getParameter("pagination")),
                                    req.getParameter("type"),
                                    req.getParameter("offset").equals("") ? 0
                                            : Integer.parseInt(req.getParameter("offset"))),
